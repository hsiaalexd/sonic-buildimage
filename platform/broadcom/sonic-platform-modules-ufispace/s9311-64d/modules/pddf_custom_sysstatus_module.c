...
PDDF_DATA_ATTR(cpld3_build    , S_IRUGO, show_sysstatus_data, NULL, PDDF_UCHAR, sizeof(u8), NULL, NULL);
...
PDDF_DATA_ATTR(fpga_build     , S_IRUGO, show_sysstatus_data, NULL, PDDF_UCHAR, sizeof(u8), NULL, NULL);
...
PDDF_DATA_ATTR(cpld_port_led_clr , S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
...
static struct attribute *sysstatus_data_attributes[] = {
    ...
    &attr_cpld3_build.dev_attr.attr,
    &attr_fpga_major_ver.dev_attr.attr,
